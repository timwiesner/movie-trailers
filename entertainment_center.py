"""
movie_website contains a program which displays movies and their relevant
information.
...
inside_llewyn_davis = media.Movie(
    "Inside Llewyn Davis",
    """A week in the life of a young singer as he navigates the Greenwich
    Village folk scene of 1961.""",
    "http://t3.gstatic.com/images?q=tbn:ANd9GcSLO-BiIX0rnumBd9eL7gIDsKlwIR9zSZc9LQxggueQi_-IPGof",  # NOQA
...
pineapple_express = media.Movie(
    "Pineapple Express",
    """A process server and his marijuana dealer wind up on the run from
    hitmen and a corrupt police officer after he witnesses his dealer's boss
    murder a competitor while trying to serve papers on him.""",
    "https://images-na.ssl-images-amazon.com/images/M/MV5BMTY1MTE4NzAwM15BMl5BanBnXkFtZTcwNzg3Mjg2MQ@@._V1_UX182_CR0,0,182,268_AL_.jpg",  # NOQA
...
movies = [inside_llewyn_davis, inglorious_basterds, pulp_fiction, inception,
          fight_club, pineapple_express]
